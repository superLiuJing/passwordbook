...
public class LocalAndroidKeyStore {
    ...
    public static final String keyName = "iliujing";
    ...
    public void generateKey(String keyAlias) {
        ...
        try {
            ...
            mStore.load(null);
            SecretKey key = (SecretKey) mStore.getKey(keyAlias, null);
            if (key != null) {
                return ;
            }
    ...
    public BiometricPrompt.CryptoObject getBiometricCryptoObject(int purpose, byte[] IV) {
        try {
            mStore.load(null);
            final SecretKey key = (SecretKey) mStore.getKey(keyName, null);
            if (key == null) {
